                            ...
                            <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                                ...
                                <form>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="text" type="text" class="form-control" id="email" value="<?= $user['username'] ?>" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="text" type="text" class="form-control" id="name" value="<?= $user['name'] ?>">
                                        </div>
                                    </div>
